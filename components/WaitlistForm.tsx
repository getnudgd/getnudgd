...
// Animation 7 — Animated SVG checkmark on success
...
export function WaitlistForm({ variant = "hero" }: { variant?: Variant }) {
  ...
  // Remove shake class once animation ends
    ...
    <div className={isCta ? "cta-form" : ""}>
      {!success ? (
        ...
        <div className="wl-success">
          {/* Animation 7 — SVG checkmark draws itself */}
          <svg
          ...
          <h3 className="ok">
            {isCta ? "Done. We'll be in touch." : "You're on the list."}
          </h3>
          <p>
            {isCta
